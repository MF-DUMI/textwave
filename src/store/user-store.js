...
import { setDoc, getDoc, doc, collection ,getDocs, updateDoc, arrayUnion, onSnapshot, query } from 'firebase/firestore'
        ...
        async sendMessage(data){
            ...
            try {
                ...
                if (data.chatId){
                    ...
                    //this.getChatById(data.chatId); // Update current chat after sending a message
                    ...
                    //this.getChatById(id); // Fetch new chat details
