      ...
      <div class="w-full">
        ...
        <div class="border-l border-green-500 w-full">
          <div class="bg-[#F0F0F0] fixed z-10 min-w-[calc(100vw-420px)] flex justify-between items-center px-2 py-2">
            <div class="flex items-center">
              ...
              <div v-if = "userDataForChat[0] && userDataForChat[0].firstName"class="text-gray-900 ml-1 font-semibold">{{ userDataForChat[0].firstName }}</div>
            </div>
        ...
        <div class="w-[calc(100vw-420px)] p-2.5 z-10 bg-[#F0F0F0] fixed bottom-0">
          <div class="flex items-center justify-center">
            ...
            <PaperclipIcon :size="27" fillColor="#515151" class="mx-15 mr-3" />
            <input
              v-model = "message"
...
<style>
#BG {
background: url("/message-bg.png") no-repeat center center;
